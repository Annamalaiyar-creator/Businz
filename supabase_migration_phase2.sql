-- ==============================================================================
-- BUSINZ ERP: Phase 2 Database Schema Migration
-- Project: ognmvcpzlebrvdynunwh (Supabase PostgreSQL)
-- Target: Relational CRM, Sales, Operations, Inventory & Production Architecture
-- SAFETY GUARANTEES:
--   1. Zero DROP TABLE statements.
--   2. Zero DELETE FROM statements.
--   3. All statements are idempotent (IF NOT EXISTS).
--   4. Existing 30 users, 98 POs, 273 leaves, 4 controlroom_store records are preserved.
-- ==============================================================================
...
-- ==============================================================================
-- 1. ALTER EXISTING TABLES (Add missing non-destructive columns)
-- ==============================================================================

-- Extended columns for existing purchase_orders table
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS branch TEXT;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS contact_person TEXT;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS contact_no TEXT;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS email TEXT;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS gst_no TEXT;
...
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS purchaser TEXT;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS approval_remarks TEXT;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS approval_date TEXT;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS approval_time TEXT;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS payment_details JSONB;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS proceed_details JSONB;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS delivery_type TEXT;
ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS pdf_name TEXT;
...
-- ==============================================================================
-- 4. CANONICAL CUSTOMERS (Merged from customer_store + crm_customers)
-- ==============================================================================
...
-- ==============================================================================
-- 5. ITEMS & FINISHED PRODUCTS CATALOG
-- ==============================================================================
...
-- ==============================================================================
-- 10. QUOTATIONS (Unified Sales & CRM Quotations)
-- ==============================================================================

CREATE TABLE IF NOT EXISTS public.quotations (
  id TEXT PRIMARY KEY,
  quote_number TEXT UNIQUE NOT NULL,
  source_type TEXT DEFAULT 'sales', -- 'sales' or 'crm'
...
-- ==============================================================================
-- 13. GOODS RECEIPT NOTES (GRN Flow)
-- ==============================================================================
...
-- ==============================================================================
-- 15. PRODUCTION WORK ORDERS (Unified ERP & Floor Manufacturing)
-- ==============================================================================
...
-- ==============================================================================
-- 16. PRODUCTION INVENTORY & RECIPES & LEDGER
-- ==============================================================================
...
-- ==============================================================================
-- 17. INVOICES & PAYMENTS (Accounts Flow)
-- ==============================================================================
...
SELECT 'BUSINZ Phase 2 Schema definitions prepared successfully!' as status;
